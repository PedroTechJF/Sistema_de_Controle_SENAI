        ...
        <div class="container">
            <div class="main_form">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="form">
                    ...
                    <input type="text" name="perfil" id="perfilFinal" value="alunos" hidden>
                    <input type="button" class="submitBtn" value="Entrar">
                </form>
                <div class="extraBtns">
                    <a href="signup.php" class="a_login">Cadastre-se Agora</a>
                    <a href="atualizar_senha.php?perfil=alunos" class="a_login">Esqueceu sua Senha?</a>        
                </div>
                <div class="responseMsg"></div>
            </div>
            <div class="extraBtns bottomBtns">
                <a href="login_esc.php" class="a_login">Sou Escola</a>
                <p style="margin: 0">/</p>
